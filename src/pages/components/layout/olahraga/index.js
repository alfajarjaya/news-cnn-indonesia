...
const Olga = () => {
    ...
    const paginatedNews = olgaNews.slice(startIdx, endIdx);
    ...
    return (
        <>
            ...
            <div className="mt-15">
                ...
                <h2 className="text-center mb-4 fs-5 text-gray">Sport news update for today !</h2>
            </div>
            <div className="container mb-5 d-flex justify-content-between">
                <div className="row mx-3 w-100 h-100">
                    <div className='d-flex align-items-center mb-5'>
                        <h3 className='fw-bold mx-2'>SPORT <span className='text-danger'>|</span></h3>
                        <h6>
                                    ...
                                    <ul className="pagination">
                                        {currentPage > 1 && (
                                            <li className="page-item">
                                                <a className="page-link" href={`/id/olahraga?page=${currentPage - 1}`} aria-label="Previous">
                                        ...
                                        {[...Array(10)].map((_, index) => {
                                            ...
                                            return (
                                                <li key={page} className={`page-item ${page === currentPage ? 'active' : ''}`}>
                                                    <a className="page-link" href={`/id/olahraga?page=${page}`}>{page}</a>
                                                </li>
                                            );
                                        })}
                                        ...
                                        {currentPage < 10 && (
                                            <li className="page-item">
                                                <a className="page-link" href={`/id/olahraga?page=${currentPage + 1}`} aria-label="Next">
